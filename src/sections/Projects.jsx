...
const Projects = () => {
  ...
  return (
    <section className="c-space my-20 section" id="projects">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        ...
        <div className="border border-black-300 bg-black-200 rounded-lg h-96 md:h-full shadow-xl shadow-sky-400/25">
          <Canvas>
            ...
            <Center>
              <Suspense fallback={<CanvasLoader />}>
                <group scale={2} position={[0, -3, 0]} rotation={[0, -0.1, 0]}>
                  <DemoComputer texture={currentProject.texture} scale={1} />
                </group>
              </Suspense>
            </Center>
